...
<p>
  ...
  development through the ongoing Doosan Robotics Bootcamp.
</p>
...
<p align="center">
  <img
    src="https://komarev.com/ghpvc/?username=EuiseokJeongNZ&amp;label=Profile%20Views&amp;color=5EA58B&amp;style=flat"
    alt="Profile Views"
  />
</p>
...
<ul>
  <li>
    Robotics software, robot control, computer vision,
    intelligent automation, and industrial automation.
  </li>
</ul>
...
<ul>
  <li>
    <strong>Description:</strong>
    Production-style e-commerce application featuring HTTP-only
    cookie-based JWT authentication, automatic token refresh,
    checkout, order management, and purchase-verified reviews.
  </li>
...
<ul>
  <li>
    ...
    30 football and baseball ticket product pages deployed on a
    live e-commerce service.
  </li>

  <li>
    <strong>Key Features:</strong>
    Interactive seat overlays, linked legends, desktop tooltips,
    mobile bottom sheets, keyboard accessibility,
...
<ul>
  <li>
    <strong>Description:</strong>
    Selected AI and computer vision exercises completed as part of
    the ongoing Doosan Robotics Bootcamp.
  </li>

  <li>
    <strong>Topics:</strong>
    Image processing, deep learning fundamentals,
    model training, and computer vision practice.
  </li>
...
<h3>🤖 Doosan Robotics Bootcamp</h3>

<p>
  <strong>Category:</strong> Training<br>
  <strong>Organisation:</strong> Doosan Robotics<br>
  <strong>Date:</strong> 2026–Present<br>
...
<p>
  ...
  <strong>Organisation:</strong> Auckland University of Technology<br>
  <strong>Date:</strong> Jul 2023–Dec 2025<br>
...
<p>
  <strong>Category:</strong> Experience<br>
  <strong>Organisation:</strong> HeartFull.Online / BetaBuilders<br>
  <strong>Date:</strong> Jul–Oct 2025<br>
  <strong>Credential:</strong>
...
<h3>☁️ Microsoft Certified: Azure Fundamentals</h3>

<p>
  <strong>Category:</strong> Certification<br>
  <strong>Organisation:</strong> Microsoft<br>
  <strong>Date:</strong> Oct 2025<br>
  <strong>Credential:</strong>
...
<h3>☁️ Microsoft Skills Bootcamp – Azure Fundamentals</h3>

<p>
  <strong>Category:</strong> Training<br>
  <strong>Organisation:</strong> Akkodis Academy<br>
  <strong>Date:</strong> Sep 2025<br>
  <strong>Credential:</strong>
...
<p>
  ...
  <a href="https://www.postgresql.org/docs/current/sql.html" target="_blank">
    <img
      alt="SQL"
      src="https://img.shields.io/badge/SQL-4479A1?style=flat&amp;logo=postgresql&amp;logoColor=white"
    />
  </a>
</p>
...
<p>
  <a href="https://docs.ros.org/en/rolling/" target="_blank">
    <img
      alt="ROS 2 Learning"
      src="https://img.shields.io/badge/ROS%202-Learning-22314E?style=flat&amp;logo=ros&amp;logoColor=white"
    />
  </a>
...
<p>
  ROS 2 Nodes · Topics · Services · Linux · Ubuntu · Computer Vision
</p>
...
<p>
  ...
  <a href="https://colab.research.google.com/" target="_blank">
    <img
      alt="Google Colab"
      src="https://img.shields.io/badge/Google%20Colab-F9AB00?style=flat&amp;logo=googlecolab&amp;logoColor=white"
    />
  </a>
</p>
